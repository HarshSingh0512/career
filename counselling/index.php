	...
	<div class="row">
		<div class="col-sm-12">
			 <div class="panel panel-danger">
				  <div class="panel-heading">Register and then login</div>
  </div>
			</div>
		</div>
    </div>
			     ...
			     <div class="col-sm-6">
				   ...
				   <div class="col-sm-6">
							<div class="panel panel-info">
								...
								<div class="panel-heading">Registor Form</div>
							<div class="panel-body">
							<?php 
							if(isset($_GET['run'])&& $_GET['run']=="success")
							{
								echo "<mark class='bg-primary'>Your registration successfully done</mark>";
							} 
							?>
